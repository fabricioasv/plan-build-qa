...
| --- | --- | --- | --- | --- | --- | --- |
| check-harness-structure | fast | sim | passou | `powershell -NoProfile -ExecutionPolicy Bypass -File .\.plan-build-qa\harness\scripts\run-fast.ps1` | 0 | Executado manualmente em 2026-05-23; output confirmou `Structure OK` e `OK` no runner fast. |
| npm-run-test | medium | sim | passou | `npm run test` | 0 | Executado em 2026-05-23T22:54:23.668Z |
...
- Executado em: 2026-05-23T22:54:29.693Z
- Tiers: fast, medium
...
Nenhuma violacao critica encontrada pelos sensores executados e registrados.
