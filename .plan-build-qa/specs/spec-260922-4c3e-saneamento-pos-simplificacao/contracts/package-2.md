...
Remover `constitution/repository-rules.md` (redundante com `AGENTS.md`/`CLAUDE.md`). Detalhamento completo fica para quando este package for puxado.

## Arquivos Permitidos

TBD ao puxar o package — provavelmente `constitution/repository-rules.md`, `bin/pbq.mjs` (geracao desse arquivo em `init`), `manifest.json`.
