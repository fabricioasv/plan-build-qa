...
| pbq-analyze | fast | sim | passou | `node ./bin/pbq.mjs analyze .` | 0 | ...ocal-global/package-4.md: sensor obrigatorio citado sem nome cadastrado em sensors.json  - spec-025-sensor-scope-local-global/package-4.md: sensor obrigatorio citado sem nome cadastrado em sensors.json  - spec-025-sensor-scope-local-global/package-4.md: sensor obrigatorio citado sem nome cadastrado em sensors.json  - spec-025-sensor-scope-local-global/package-4.md: sensor obrigatorio citado sem nome cadastrado em sensors.json [pbq] Resumo: 0 violacoes, 37 warnings em 27 specs [pbq] Resultado: OK |
...
- Executado em: 2026-07-05T01:30:05.791Z
- Tiers: fast, medium
