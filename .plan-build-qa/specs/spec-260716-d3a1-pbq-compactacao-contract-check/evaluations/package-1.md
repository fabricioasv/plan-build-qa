...
| pbq-analyze | fast | sim | passou | `node ./bin/pbq.mjs analyze .` | 0 | ...ocal-global/package-4.md: sensor obrigatorio citado sem nome cadastrado em sensors.json  - spec-025-sensor-scope-local-global/package-4.md: sensor obrigatorio citado sem nome cadastrado em sensors.json  - spec-025-sensor-scope-local-global/package-4.md: sensor obrigatorio citado sem nome cadastrado em sensors.json  - spec-025-sensor-scope-local-global/package-4.md: sensor obrigatorio citado sem nome cadastrado em sensors.json [pbq] Resumo: 0 violacoes, 37 warnings em 29 specs [pbq] Resultado: OK |
...
- Executado em: 2026-07-17T00:52:09.285Z
- Tiers: fast, medium
