...
| pbq-analyze | fast | sim | passou | `node ./bin/pbq.mjs analyze .` | 0 | ...package-1.md: sensor obrigatorio citado sem nome cadastrado em sensors.json  - spec-025-sensor-scope-local-global/package-1.md: sensor obrigatorio citado sem nome cadastrado em sensors.json  - spec-025-sensor-scope-local-global: package 2 declarado na spec sem contract  - spec-025-sensor-scope-local-global: package 3 declarado na spec sem contract  - spec-025-sensor-scope-local-global: package 4 declarado na spec sem contract [pbq] Resumo: 0 violacoes, 28 warnings em 25 specs [pbq] Resultado: OK |
...
- Executado em: 2026-06-28T01:35:22.985Z
- Tiers: fast, medium
